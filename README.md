...
- Wanda: A Simple and Effective Pruning Approach For Large Language Models
    ...
    - Experiment results: First we should make the experiment settings clear-Zero-shot tasks are done using code from EltheutherAI LM Harness.Meanwhile, both 
      ...
      focus on pruning the linear layers(all layers except the first embedding layer and the final classification head). Here are the results:
                         <p align="center">
                         <img width="70%" alt="image" src="Pictures/Wanda/Wanda experiment result 1.jpg">       
                         <img width="70%" alt="image" src="Pictures/Wanda/Wanda experiment result 2.jpg">         
                         </p>
                         perplexity results and zero-shot results
                         <p align="center">
                         <img width="70%" alt="image" src="Pictures/Wanda/Wanda experiment result 3.jpg">            
                         </p>
		         Experiment results with higher sparsity
			 <p align="center">
                         <img width="70%" alt="image" src="Pictures/Wanda/Wanda experiment result 4.jpg">       
